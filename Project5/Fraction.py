...
if __name__ == '__main__':
  ...
  arr = [Fraction(3,4), Fraction(5,10), Fraction(100,240), Fraction(5,6), Fraction(8,40), Fraction(33,99), Fraction(34,99), Fraction(17,19), Fraction(-2,50), Fraction(-1,2), Fraction(-2,-5), Fraction(5,-18)]
  ...
  arr1 = [Fraction(-6,10), Fraction(2,3),Fraction(-3,9), Fraction(-10,25), Fraction(-2,7), Fraction(-5,13), Fraction(-1,-2), Fraction(9,13), Fraction(13,17)]
